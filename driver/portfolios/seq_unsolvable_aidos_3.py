...
CONFIGS = [
    ...
    (8, [
        ...
        "--heuristic",
        "h_cegar=cegar(subtasks=[original(copies=1)], max_states=10, use_general_costs=true, cost_type=one, max_time=911.464940218, pick=min_unwanted, cache_estimates=false)",
        "--heuristic",
        "h_deadpdbs=deadpdbs(patterns=combo(max_states=1), cost_type=one, max_dead_ends=290355, max_time=1798.11419817, cache_estimates=false)",
        "--heuristic",
    ...
    (6, [
        "--heuristic",
        "h_deadpdbs=deadpdbs(patterns=genetic(disjoint=false, mutation_probability=0.2794745683909153, pdb_max_size=1, num_collections=40, num_episodes=2), cost_type=normal, max_dead_ends=36389913, max_time=947.343297923, cache_estimates=false)",
        "--heuristic",
    ...
    (2, [
        ...
        "h_blind=blind(cache_estimates=false, cost_type=one)",
        "--heuristic",
        "h_deadpdbs=deadpdbs(cache_estimates=false, cost_type=one, max_dead_ends=4, max_time=1528.48619963, patterns=systematic(only_interesting_patterns=false, pattern_max_size=15))",
        "--heuristic",
    ...
    (4, [
        "--heuristic",
        "h_cegar=cegar(subtasks=[original(copies=1)], max_states=114, use_general_costs=false, cost_type=normal, max_time=31.4194389849, pick=max_hadd, cache_estimates=false)",
        "--heuristic",
        ...
        "--heuristic",
        "h_deadpdbs=deadpdbs(cache_estimates=true, cost_type=normal, max_dead_ends=12006, max_time=380.229024557, patterns=genetic(disjoint=true, mutation_probability=0.7174375735405052, num_collections=4, num_episodes=170, pdb_max_size=1))",
        "--heuristic",
    ...
    (7, [
        ...
        "h_blind=blind(cache_estimates=false, cost_type=one)",
        "--heuristic",
        "h_cegar=cegar(subtasks=[original(copies=1)], max_states=5151, use_general_costs=false, cost_type=one, max_time=797.408130433, pick=max_hadd, cache_estimates=false)",
        "--heuristic",
        "h_hmax=hmax(cache_estimates=false, cost_type=one)",
        "--heuristic",
    ...
    (33, [
        ...
        "--heuristic",
        "h_cegar=cegar(subtasks=[goals(order=hadd_down), landmarks(order=original, combine_facts=true), original(copies=1)], max_states=601, use_general_costs=false, cost_type=normal, max_time=1600.8777461, pick=min_unwanted, cache_estimates=true)",
        "--heuristic",
        "h_deadpdbs_simple=deadpdbs_simple(cache_estimates=true, cost_type=normal, patterns=hillclimbing(min_improvement=2, pdb_max_size=7349527, collection_max_size=233, max_time=576.597690074, num_samples=28))",
        "--heuristic",
        "h_initial_state_potential=initial_state_potential(max_potential=1e8, cache_estimates=false, cost_type=normal)",
        "--heuristic",
        "h_operatorcounting=operatorcounting(cache_estimates=false, cost_type=normal, constraint_generators=[feature_constraints(max_size=10), lmcut_constraints(), pho_constraints(patterns=hillclimbing(min_improvement=2, pdb_max_size=7349527, collection_max_size=233, max_time=576.597690074, num_samples=28)), state_equation_constraints()])",
        "--heuristic",
        "h_pdb=pdb(pattern=greedy(max_states=6), cost_type=normal, cache_estimates=true)",
        "--heuristic",
        "h_zopdbs=zopdbs(patterns=hillclimbing(min_improvement=2, pdb_max_size=7349527, collection_max_size=233, max_time=576.597690074, num_samples=28), cost_type=normal, cache_estimates=false)",
        "--search",
    ...
    (150, [
        "--heuristic",
        "h_deadpdbs=deadpdbs(cache_estimates=false, cost_type=one, max_dead_ends=6, max_time=1351.21278519, patterns=systematic(only_interesting_patterns=true, pattern_max_size=1))",
        "--search",
    ...
    (1549, [
        "--heuristic",
        "h_deadpdbs=deadpdbs(cache_estimates=false, cost_type=one, max_dead_ends=63156737, max_time=84.8916514771, patterns=ordered_systematic(pattern_max_size=869))",
        "--heuristic",
