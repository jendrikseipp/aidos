...
configs = [
    IssueConfig(
        "cggl-modlabelb50k",
        ["--search", "astar(merge_and_shrink(shrink_strategy=shrink_mod_label(max_states=50000,threshold=1,greedy=false),merge_strategy=merge_linear(variable_order=cg_goal_level),label_reduction=exact(before_shrinking=true,before_merging=false),only_dead_end_detection=false))"]),
    IssueConfig(
    ...
    IssueConfig(
        "gcgl-modlabelb50k",
        ["--search", "astar(merge_and_shrink(shrink_strategy=shrink_mod_label(max_states=50000,threshold=1,greedy=false),merge_strategy=merge_linear(variable_order=goal_cg_level),label_reduction=exact(before_shrinking=true,before_merging=false),only_dead_end_detection=false))"]),
    IssueConfig(
    ...
    IssueConfig(
        "rl-modlabelb50k",
        ["--search", "astar(merge_and_shrink(shrink_strategy=shrink_mod_label(max_states=50000,threshold=1,greedy=false),merge_strategy=merge_linear(variable_order=reverse_level),label_reduction=exact(before_shrinking=true,before_merging=false),only_dead_end_detection=false))"]),
    IssueConfig(
    ...
    IssueConfig(
        "l-modlabelb50k",
        ["--search", "astar(merge_and_shrink(shrink_strategy=shrink_mod_label(max_states=50000,threshold=1,greedy=false),merge_strategy=merge_linear(variable_order=level),label_reduction=exact(before_shrinking=true,before_merging=false),only_dead_end_detection=false))"]),
    IssueConfig(
